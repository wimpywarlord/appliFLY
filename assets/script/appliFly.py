...
try:
    ...
    print(
        "3. In case of errror, document the error and report to the github repository @https://github.com/wimpywarlord."
    )
    ...
    on_campus_job_button = chromeDriver.find_element(
        By.XPATH,
        "/html/body/div[3]/div[2]/main[3]/div/div/div/div[2]/div/div/div/div/div[1]/div/div/div/div[1]/a/button",
    )
    ...
    login_button = chromeDriver.find_element(
        By.XPATH, "/html/body/div/div/main/div/div/div/div/form/section[2]/div[1]/input"
    )
    ...
    duo_security_iframe = chromeDriver.find_element(
        By.XPATH, "/html/body/div/div/main/div/form/div/iframe"
    )
    chromeDriver.switch_to.frame(duo_security_iframe)

    wait_for_send_duo_push_button = WebDriverWait(chromeDriver, 10)
    wait_for_send_duo_push_button.until(
    ...
    send_duo_push_button = chromeDriver.find_element(
        By.XPATH, "/html/body/div/div/div[1]/div/form/div[1]/fieldset/div[1]/button"
    )
    ...
    wait_for_search_button_job_portal.until(
        EC.element_to_be_clickable((By.ID, "searchControls_BUTTON_2"))
    )
    job_portal_search_button = chromeDriver.find_element(
        By.ID, "searchControls_BUTTON_2"
    )
    ...
    print(f"There are {len(job_title_links)} jobs available for you to apply.")
    ...
    for link in job_title_links:
        ...
        wait_for_apply_button_job_desc.until(
            EC.element_to_be_clickable((By.ID, "applyFromDetailBtn"))
        )
        ...
        wait_for_lets_get_started_button.until(
            EC.element_to_be_clickable((By.ID, "startapply"))
        )
        ...
        wait_for_save_and_continue_button.until(
            EC.element_to_be_clickable((By.ID, "shownext"))
        )
        ...
        wait_for_sponsorship_radio_button.until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div/div/div[2]/fieldset/div/div[1]/input",
                )
            )
        )
        sponsorship_radio_button = chromeDriver.find_element(
            By.XPATH,
            "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div/div/div[2]/fieldset/div/div[1]/input",
        )
        ...
        if os.getenv("FEDERAL_WORK_STUDY").lower() == "true":
            ...
            wait_for_federal_work_study_button.until(
                EC.element_to_be_clickable(
                    (
                        By.XPATH,
                        "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div/div/div[6]/fieldset/div/div[1]/input",
                    )
                )
            )
            federal_work_study_button = chromeDriver.find_element(
                By.XPATH,
                "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div/div/div[6]/fieldset/div/div[1]/input",
            )
        else:
            ...
            federal_work_study_button = chromeDriver.find_element(
                By.XPATH,
                "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div/div/div[6]/fieldset/div/div[2]/input",
            )
        federal_work_study_button.click()
        # How did you find out about this job?
        wait_for_where_you_found_the_job_drop_down = WebDriverWait(chromeDriver, 30)
        wait_for_where_you_found_the_job_drop_down.until(
            EC.visibility_of_element_located(
                (
                    By.XPATH,
                    "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div/div/div[7]/span[2]/span[2]",
                )
            )
        )
        where_you_found_the_job_drop_down = chromeDriver.find_element(
            By.XPATH,
            "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div/div/div[7]/span[2]/span[2]",
        )
        ...
        # How did you find out about this job?
        wait_for_where_you_found_the_job_drop_down_options = WebDriverWait(
            chromeDriver, 30
        )
        wait_for_where_you_found_the_job_drop_down_options.until(
            EC.visibility_of_element_located(
                (
                    By.XPATH,
                    "/html/body/div[2]/div[2]/div[1]/div[7]/div[5]/div[1]/ul/li[4]/div",
                )
            )
        )
        where_you_found_the_job_drop_down_options = chromeDriver.find_element(
            By.XPATH,
            "/html/body/div[2]/div[2]/div[1]/div[7]/div[5]/div[1]/ul/li[4]/div",
        )
        ...
        wait_for_save_and_next.until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[4]/button",
                )
            )
        )
        save_and_next = chromeDriver.find_element(
            By.XPATH,
            "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[4]/button",
        )
        save_and_next.click()
        ...
        wait_for_save_and_next_part_2.until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[4]/button",
        ...
        save_and_next_part_2 = chromeDriver.find_element(
            By.XPATH,
            "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[4]/button",
        )
        ...
        wait_for_resume_file_input.until(
            EC.element_to_be_clickable((By.ID, "AddResumeLink"))
        )
        ...
        wait_for_resume_file_upload_modal.until(
            EC.element_to_be_clickable((By.XPATH, "/html/body/div[3]/div[2]"))
        )

        upload_resume_modal_iframe = chromeDriver.find_element(
            By.XPATH, "/html/body/div[3]/div[2]/iframe"
        )
        chromeDriver.switch_to.frame(upload_resume_modal_iframe)

        browse_local_for_resume_button = chromeDriver.find_element(
            By.XPATH, "/html/body/div[2]/div/div[1]/div/div/div[3]/label/input"
        )
        ...
        wait_for_cover_letter_file_input.until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div[2]/div/div[4]/div/div/div[3]/p/a",
                )
            )
        )
        cover_letter_file_input = chromeDriver.find_element(
            By.XPATH,
            "/html/body/div[2]/div[2]/div[1]/div[7]/div[3]/form/div/div[1]/div[2]/div/div/div/div[2]/div/div[4]/div/div/div[3]/p/a",
        )
        ...
        wait_for_cover_letter_file_upload_modal.until(
            EC.element_to_be_clickable((By.XPATH, "/html/body/div[3]/div[2]"))
        )

        upload_cover_letter_modal_iframe = chromeDriver.find_element(
            By.XPATH, "/html/body/div[3]/div[2]/iframe"
        )
        chromeDriver.switch_to.frame(upload_cover_letter_modal_iframe)

        browse_local_for_cover_letter = chromeDriver.find_element(
            By.XPATH, "/html/body/div[2]/div/div[1]/div/div/div[3]/label/input"
        )
        ...
        wait_for_save_and_next_part_3.until(
            EC.element_to_be_clickable((By.ID, "shownext"))
        )
        ...
        wait_for_save_and_next_part_4.until(
            EC.element_to_be_clickable((By.ID, "shownext"))
        )
        ...
        wait_for_save_and_next_part_5.until(
            EC.element_to_be_clickable((By.ID, "shownext"))
        )
        ...
        wait_for_save_and_next_part_6.until(
            EC.element_to_be_clickable((By.ID, "shownext"))
        )
        ...
        wait_for_save_and_next_part_7.until(
            EC.element_to_be_clickable((By.ID, "shownext"))
        )
        ...
        wait_for_save_and_next_part_8.until(
            EC.element_to_be_clickable((By.ID, "shownext"))
        )
    ...
    print("Dᴇᴠᴇʟᴏᴘᴇᴅ Bʏ Kꜱʜɪᴛɪᴊ Dʜʏᴀɴɪ")
    print(
        "Thanks for using. If this helped, be sure to star the project on Github @https://github.com/wimpywarlord"
    )
    ...
    print(
        "An error occured. Please document & report it to the developer @https://github.com/wimpywarlord"
    )
    print(e)
